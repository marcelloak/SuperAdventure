namespace Engine
{
    public class Monster : LivingCreature
    {
        ...
        public Monster(int id, string name, int maximumDamage, int rewardGold, int rewardExperiencePoints, int currentHitPoints, int maximumHitPoints, int hitChance, int defence) : base(currentHitPoints, maximumHitPoints)
        {
            ID = id;
            Name = name;
        ...
        {
            Monster newMonster = new Monster(ID, Name, MaximumDamage, RewardGold, RewardExperiencePoints, CurrentHitPoints, MaximumHitPoints, HitChance, Defence);
